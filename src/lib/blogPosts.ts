export const posts = [
  ...
  },
  {
    ...
    content: '<p>Firebase se ha convertido en mi backend favorito para muchos proyectos frontend debido a su facilidad de uso y la gran cantidad de servicios que ofrece. Utilizo Firestore para bases de datos en tiempo real, lo que simplifica enormemente la gestión de datos. La autenticación de Firebase me permite implementar sistemas de inicio de sesión seguros de manera rápida. Además, Firebase Storage es ideal para almacenar archivos como imágenes. La integración de Firebase con aplicaciones frontend es muy fluida, lo que me permite concentrarme en la experiencia del usuario sin tener que preocuparme tanto por la infraestructura del backend.</p>',
